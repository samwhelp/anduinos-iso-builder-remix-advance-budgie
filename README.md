...
# anduinos-iso-builder-remix-advance-budgie
...
| Link | GitHub |
| ---- | ------ |
| [AnduinOS / ISO Builder / Remix Prototype / Budgie](https://samwhelp.github.io/anduinos-iso-builder-remix-advance-budgie/) | [GitHub](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-budgie) |
...
* [Module / Ignored](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-budgie/blob/main/helper/docs/module/module-ignored.md)
* [Module / Adjusted](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-budgie/blob/main/helper/docs/module/module-adjusted.md)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-budgie/tree/main/asset/template/src/mods/14-my-extra-1020-overlay-mod/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-budgie/tree/main/asset/template/src/mods/14-my-extra-1020-overlay-mod/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-budgie/tree/main/asset/template/src/mods/14-my-extra-1020-overlay-mod/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [anduinos-iso-builder-remix-advance-budgie](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-budgie)

``` sh
git clone https://github.com/samwhelp/anduinos-iso-builder-remix-advance-budgie.git
```


> change dir to `anduinos-iso-builder-remix-advance-budgie`

``` sh
cd anduinos-iso-builder-remix-advance-budgie
```
...
> change dir to `~/work/anduinos-iso-builder-remix-advance-budgie/iso-profile`

``` sh
cd ~/work/anduinos-iso-builder-remix-advance-budgie/iso-profile
```
...
> change dir to `~/work/anduinos-iso-builder-remix-advance-budgie/iso-profile/src`

``` sh
cd ~/work/anduinos-iso-builder-remix-advance-budgie/iso-profile/src
```
